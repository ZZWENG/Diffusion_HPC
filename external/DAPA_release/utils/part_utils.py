...
class PartRenderer():
    ...
    def __call__(self, vertices, camera):
        ...
        parts, something, mask =  self.neural_renderer(vertices, faces, textures=self.textures.expand(batch_size, -1, -1, -1, -1, -1), K=K, R=R, t=cam_t.unsqueeze(1))
#         return parts, something, mask
